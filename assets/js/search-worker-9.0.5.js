...
importScripts('/hj-test/assets/js/kv-storage-polyfill/dist/kv-storage-polyfill.umd.js');
self.storage = kvStoragePolyfill.default;
self.StorageArea = kvStoragePolyfill.StorageArea;

const DATA_URL = '/hj-test/assets/sitedata.json?no-cache';
...
importScripts('/hj-test/assets/js/minisearch/dist/umd/index.min.js');
const INDEX_KEY = 'index--2020-11-06T07:29:25+00:00';
const storage = new StorageArea('mini-search/hj-test/');
